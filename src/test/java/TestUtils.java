...
public class TestUtils {
    ...
    public JSONObject putWaybill() {
        ...
        waybillObject.put("EWB_DATE", new Date());//寄件日期
        ...
        waybillObject.put("IMG_DATE", new Date());//高扫仪录单图片上传时间
        waybillObject.put("RETURN_DATE", new Date());//高扫仪录单图片回传时间
        ...
        waybillObject.put("ARRIVE_OPT_AMOUNT", "35");//到付操作费
        waybillObject.put("KFBXF_CHARGE", "34");//客户保险费
        waybillObject.put("FUEL_ADD_CHARGE", "33");//燃油附加费
        waybillObject.put("PICKUP_CHARGE", "66");//提货费
        waybillObject.put("EC_IN_CHARGE", "34");//电商入仓费
        waybillObject.put("KFSLF_CHARGE", "45");//客户上楼费
        ...
        waybillObject.put("PIC_EWB_ID", "");//面单图片ID
    ...
    public JSONObject putPrint(JSONObject waybillObject) {
        ...
        printJson.put("PRINT_EWB_TYPE", "");
        printJson.put("EWB_NO", "301712111009");//运单号
        printJson.put("PRINT_SITE_ID", 2092);//打印网点ID
        printJson.put("PRINT_PIECE", "1");//打印件数
        printJson.put("PRINT_SERVICES_TYPE_ID", "");//打印产品类型
        printJson.put("PRINT_PICK_GOODS_MODE_ID", "");//打印服务方式
        printJson.put("CREATED_BY", "");//打印人
        printJson.put("CREATED_TIME", "");//打印时间
    ...
    public JSONObject putCustoms(JSONObject waybillObject) {
        ...
        customsJson.put("CUSTOMER_COUNTRY_ID", "");
    ...
    public JSONObject putEwbDetail(JSONObject waybillObject) {
        ...
        ewbDetail.put("EEWBS_FLAG", 0);//电子面单标志（0：否  1：是）
        ...
        ewbDetail.put("TOTAL_AMOUNT", "500");//实收总金额
        ewbDetail.put("BILL_CHARGE", "12");//制单费
        ewbDetail.put("COUNT_CHARGE", "12");//清点费
        ewbDetail.put("UPSTAIRS_CHARGE", "12");//上下楼费
        ewbDetail.put("WAREHOUSE_CHARGE", "12");//进仓服务费
        ewbDetail.put("OTHER_CHARGE", "13");//其它费用
        ewbDetail.put("DELIVERY_CHARGE", "14");//送货费
        ewbDetail.put("INSTALLER_CHARGE", "15");//安装费
        ewbDetail.put("REFUND_CHARGE", "13");//返款到付
        ewbDetail.put("DISPATCH_SMS_FLAG", "0");//派件短信通知收件人（0：不通知  1：通知）
        ewbDetail.put("FUEL_CHARGE", "12");//燃油费
        ewbDetail.put("PREMIUM_CHARGE", "12");//保费
        ewbDetail.put("FREIGHT_REMARK", "don't know");//运费修改原因
        ewbDetail.put("RETURN_TIME", new Date());//返款时效
        ...
        ewbDetail.put("COD_ACCOUNT_TYPE", "");//账户类型(1：个人  2：事业单位  3：公司)
        ewbDetail.put("UPSTAIRS_TYPE", "");//1：标准件上下楼	2：超标件上下楼	3：特殊件上下楼
        //=========华丽分割线=========
        //安装费-物品类型明细
        ...
        goodsJson.put("GOODS_UNIT_PRICE", "12");//单价
        goodsJson.put("GOODS_LOWEST_QUOTE", "1");//最低报价
        goodsJson.put("QUANTITY", "1");//数量
        goodsJson.put("PRICE", "12");//价格
    ...
    public JSONObject putChargeInfo(JSONObject waybillObject) {
        ...
        chargeInfo.put("cusFreightAmount", "1");//客户报价
        chargeInfo.put("bonusPoolFee", "1");//红利基金
        chargeInfo.put("transAmount", "1");
        chargeInfo.put("dispatchAmount", "1");
        chargeInfo.put("overWeightAmount", "1");
        chargeInfo.put("payDispatcherAmount", "2");
        chargeInfo.put("payOverWeightAmount", "3");
        chargeInfo.put("optAmount", "4");
        chargeInfo.put("fuelAmount", "4");
        chargeInfo.put("meetingAmount", "4");
        chargeInfo.put("meetingSubsidyAmount", "4");
        chargeInfo.put("siteMeetingAmount", "4");//网点会务费
        chargeInfo.put("paySendOperationAmount", "2");
        chargeInfo.put("reServerSubAmount", "5");//收服务补贴
        chargeInfo.put("arriveOptAmount", "4");
        chargeInfo.put("payPremiumAmount", "3");
        chargeInfo.put("receiptAmount", "3");
        chargeInfo.put("collectAmount", "1");
        chargeInfo.put("payDispatchCollectAmount", "5");
        chargeInfo.put("codOptAmount", "3");
        chargeInfo.put("siteTransAmount", "5");
        chargeInfo.put("siteReDispachFee", "1");
        chargeInfo.put("sitePayDispatchFee", "3");
        chargeInfo.put("siteDisArrivePayFee", "5");
        chargeInfo.put("premiumAmount", "4");
        chargeInfo.put("siteReArrivePayFee", "4");
        chargeInfo.put("disCharge", "3");
        chargeInfo.put("serviceCharge", "1");
        chargeInfo.put("stairsAmount", "1");//上楼费
        //特殊费用
        chargeInfo.put("dobCleanCharge", "3");//清点费
        chargeInfo.put("dobTurnOrAgencyCharge", "3");//转退件或代取件费
        chargeInfo.put("dobStoreRoomCharge", "5");//进仓服务费
        chargeInfo.put("dobSpecialAreaCharge", "6");//特殊区域加收费
        chargeInfo.put("dobSpecialCargoUpCharge", "7");//特殊货物上楼费
        chargeInfo.put("dobOverCargoCarCharge", "4");//超标货物请车费
        chargeInfo.put("dobDeadAreaCargoCarCharge", "3");//超标货物请车费
        chargeInfo.put("dobOverLimitCargoUpCharge", "3");//超标货物上楼费
        chargeInfo.put("dobHurryCargoCarCharge", "4");//加急货物请车费
    ...
    public JSONObject putSendCustomerInfo(JSONObject sendInfoObj) {
        ...
        sendCustInfoObj.put("SALES_EMPLOYEE_ID", "");
        sendCustInfoObj.put("REC_EMPLOYEE_ID", "");
        sendCustInfoObj.put("DISP_EMPLOYEE_ID", "");
        sendCustInfoObj.put("CREATED_BY", "");
    ...
    public JSONObject putSendAddress(JSONObject sendInfoObj) {
        ...
        sendCustAddressObj.put("CUSTOMER_ID", "");
        sendCustAddressObj.put("COUNTRY_ID", "");
        sendCustAddressObj.put("PROVINCE_ID", "");
        sendCustAddressObj.put("CITY_ID", "");
        sendCustAddressObj.put("COUNTY_ID", "");
        sendCustAddressObj.put("ADDRESS", "");
        sendCustAddressObj.put("PHONE_SMS", "");
        sendCustAddressObj.put("PHONE", "");
        sendCustAddressObj.put("E_MAIL", "");
        sendCustAddressObj.put("POSTCODE", "");
        sendCustAddressObj.put("BL_DEFAULT", "");
        sendCustAddressObj.put("CREATED_BY", "");
    ...
    public JSONObject putReceiveCustomerInfo(JSONObject receiveInfoObj) {
        ...
        receiveCustInfoObj.put("SALES_EMPLOYEE_ID", "");
        receiveCustInfoObj.put("REC_EMPLOYEE_ID", "");
        receiveCustInfoObj.put("DISP_EMPLOYEE_ID", "");
        receiveCustInfoObj.put("CREATED_BY", "");
    ...
    public JSONObject putReceiveAddress(JSONObject receiveInfoObj) {
        ...
        receiveCustAddressObj.put("CUSTOMER_ID", "");
        receiveCustAddressObj.put("COUNTRY_ID", "");
        receiveCustAddressObj.put("PROVINCE_ID", "");
        receiveCustAddressObj.put("CITY_ID", "");
        receiveCustAddressObj.put("COUNTY_ID", "");
        receiveCustAddressObj.put("ADDRESS", "");
        receiveCustAddressObj.put("PHONE_SMS", "");
        receiveCustAddressObj.put("PHONE", "");
        receiveCustAddressObj.put("E_MAIL", "");
        receiveCustAddressObj.put("POSTCODE", "");
        receiveCustAddressObj.put("BL_DEFAULT", "");
        receiveCustAddressObj.put("CREATED_BY", "");
    ...
    @Test
    public void cxfWs() {
        String url = "http://localhost:8085/services/NE8Service?wsdl";
    ...
    public void testJson() {
        ...
        JSONObject ewbJson = new JSONObject();
        dsAmount=dsAmount + ewbJson.getDouble("COD_CHARGE");
        System.out.println(dsAmount+"..........");
